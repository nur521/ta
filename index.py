    ...
    if call.data == "check":
        ...
        if chat_member.status in ['member', 'administrator', 'creator']:
            ...
            if not received_initial_tokens:
                ...
                web_app_url = f"https://nur521.github.io/k/?username={call.from_user.username}&user_id={user_id}&balance={user_tokens + 5000}&remaining_tokens={remaining_tokens}&referrals={referral_count}"
                ...
                web_app_url = f"https://nur521.github.io/k/?username={call.from_user.username}&user_id={user_id}&balance={user_tokens}&remaining_tokens={remaining_tokens}&referrals={referral_count}"
